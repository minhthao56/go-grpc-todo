...
func (x *TodoRequestResponse) Reset() {
	*x = TodoRequestResponse{}
...
func (x *TodoRequestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TodoRequestResponse) ProtoMessage() {}

func (x *TodoRequestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_todo_todo_proto_msgTypes[0]
...
// Deprecated: Use TodoRequestResponse.ProtoReflect.Descriptor instead.
func (*TodoRequestResponse) Descriptor() ([]byte, []int) {
	return file_todo_todo_proto_rawDescGZIP(), []int{0}
}

func (x *TodoRequestResponse) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *TodoRequestResponse) GetDescription() string {
	if x != nil {
...
func (x *TodoRequestResponse) GetIsCompleted() bool {
	if x != nil {
...
var file_todo_todo_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x70, 0x0a, 0x13, 0x54, 0x6f, 0x64, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	0x74, 0x65, 0x64, 0x32, 0x46, 0x0a, 0x0b, 0x54, 0x6f, 0x64, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x44, 0x6f, 0x12, 0x14, 0x2e,
	0x54, 0x6f, 0x64, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x1a, 0x14, 0x2e, 0x54, 0x6f, 0x64, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x67,
	0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x6f, 0x64, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_todo_todo_proto_goTypes = []interface{}{
	(*TodoRequestResponse)(nil), // 0: TodoRequestResponse
}
var file_todo_todo_proto_depIdxs = []int32{
	0, // 0: TodoService.AddToDo:input_type -> TodoRequestResponse
	0, // 1: TodoService.AddToDo:output_type -> TodoRequestResponse
...
func file_todo_todo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_todo_todo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TodoRequestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
